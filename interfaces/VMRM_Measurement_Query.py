...
class VMRM_Measurement_Query(Request):
    ...
    def unpack(self, buf):
        ...
        self._query_timestamp = buf[offset:offset + alen].decode("UTF-8")
        offset += alen
        ...
        self._file_spec = buf[offset:offset + alen].decode("UTF-8")
        offset += alen
        ...
        self._file_timestamp = buf[offset:offset + alen].decode("UTF-8")
        offset += alen
        ...
        while alen > 0:
            ...
            entry.cpu, \
            _, \
            entry.dasd = buf[offset:offset + slen].decode("UTF-8").split()
            offset += slen
            alen -= slen
