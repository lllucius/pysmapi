...
class Shared_Memory_Access_Add_DM(Smapi_Request_Base):
    def __init__(self,
                 memory_segment_name = b"",
                 **kwargs):
        super(Shared_Memory_Access_Add_DM, self). \
            __init__(b"Shared_Memory_Access_Add_DM", **kwargs)
    ...
    def pack(self):
        ...
        return super(Shared_Memory_Access_Add_DM, self).pack(buf)
