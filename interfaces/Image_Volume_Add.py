...
class Image_Volume_Add(Smapi_Request_Base):
    def __init__(self,
                 ...
                 **kwargs):
        super(Image_Volume_Add, self). \
            __init__(b"Image_Volume_Add", **kwargs)
    ...
    def pack(self):
        ...
        return super(Image_Volume_Add, self).pack(buf)
