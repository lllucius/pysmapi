...
class Image_Device_Dedicate_DM(Smapi_Request_Base):
    ...
    def __init__(self,
                 ...
                 readonly = FALSE,
                 **kwargs):
        super(Image_Device_Dedicate_DM, self). \
            __init__(b"Image_Device_Dedicate_DM", **kwargs)

        # Request parameters
        self._image_device_number = image_device_number
        self._readl_device_number = real_device_number
    ...
    def pack(self):
        ...
        return super(Image_Device_Dedicate_DM, self).pack(buf)
