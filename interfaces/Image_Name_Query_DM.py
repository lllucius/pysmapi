...
class Image_Name_Query_DM(Smapi_Request_Base):
    def __init__(self,
                 **kwargs):
        super(Image_Name_Query_DM, self). \
            __init__(b"Image_Name_Query_DM", **kwargs)
    ...
    def unpack(self, buf, offset):
        offset = super(Image_Name_Query_DM, self).unpack(buf, offset)
