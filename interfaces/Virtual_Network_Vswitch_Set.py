...
class Virtual_Network_Vswitch_Set(Request):
    ...
    def pack(self):
        ...
        buf = struct.pack(fmt,
                          ...
                          gu_len,
                          bytes(self._grant_userid, "UTF-8"),
                          uvi_len,
                          bytes(self._user_vlan_id, "UTF-8"),
                          ru_len,
                          bytes(self._revoke_userid, "UTF-8"),
                          rda_len,
                          bytes(self._real_device_address, "UTF-8"),
                          pn_len,
                          bytes(self._port_name, "UTF-8"),
                          cn_len,
                          bytes(self._controller_name, "UTF-8"),
