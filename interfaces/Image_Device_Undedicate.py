...
class Image_Device_Undedicate(Smapi_Request_Base):
    def __init__(self,
                 image_device_number = b"",
                 **kwargs):
        super(Image_Device_Undedicate, self). \
            __init__(b"Image_Device_Undedicate", **kwargs)
    ...
    def pack(self):
        ...
        return super(Image_Device_Undedicate, self).pack(buf)
