...
class Shared_Memory_Delete(Smapi_Request_Base):
    def __init__(self,
                 memory_segment_name = 0,
                 **kwargs):
        super(Shared_Memory_Delete, self). \
            __init__(b"Shared_Memory_Delete", **kwargs)
    ...
    def pack(self):
        ...
        return super(Shared_Memory_Delete, self).pack(buf)
