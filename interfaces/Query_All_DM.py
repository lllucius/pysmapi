...
class Query_All_DM(Request):
    ...
    SUBCONFIG = 7
    OTHER = 8
    directory_entry_type_names = ["OTHER"]
    ...
    def pack(self, **kwargs):
        ...
        buf = struct.pack(fmt,
                          pl_len,
                          bytes(self._query_keyword_parameter_list, "UTF-8"))
    ...
    def unpack(self, buf):
        ...
        while alen > 0:
            ...
            entry.directory_entry_id = buf[offset:offset + nlen].decode("UTF-8")
            offset += nlen
            ...
            if self._query_keyword_parameter_list.lower() == "format=yes":
                ...
                entry.directory_entry_data = buf[offset:offset + nlen].decode("UTF-8").split("\x00")
                offset += nlen
                ...
                while dlen > 0:
                    ...
                    dentry.directory_entry_data = buf[offset:offset + nlen].decode("UTF-8")
                    offset += nlen
