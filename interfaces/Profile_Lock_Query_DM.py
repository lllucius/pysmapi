...
class Profile_Lock_Query_DM(Smapi_Request_Base):
    def __init__(self,
                 **kwargs):
        super(Profile_Lock_Query_DM, self). \
            __init__(b"Profile_Lock_Query_DM", **kwargs)

        # Response values
        self._locked_type = b""
        self._profile_locked_by = b""
    ...
    def unpack(self, buf, offset):
        offset = super(Profile_Lock_Query_DM, self).unpack(buf, offset)
