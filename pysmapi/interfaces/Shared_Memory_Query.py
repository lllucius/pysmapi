...
class Shared_Memory_Query(Request):
    ...
    RESTRICTED = 3
    PENDINGPURGE = 4
    memory_segment_status_names = {SKELETON: "SKELETON", NONRESTRICTED: "NONRESTRICTED", RESTRICTED: "RESTRICTED", PENDINGPURGE: "PENDINGPURGE"}
    ...
    EN = 6
    SC = 7
    page_access_descriptor_names = {SW: "SW", EW: "EW", SR: "SR", ER: "ER", SN: "SN", EN: "EN", SC: "SC"}
    ...
    def unpack(self, buf):
        ...
        while alen > 0:
            ...
            entry.memory_segment_status = buf[offset]
            offset += 1
